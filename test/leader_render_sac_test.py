...
NUM_FAIL_REACH_GOAL = RENDER_EPISODE_NUM - NUM_COLLISION_OBS - NUM_COLLISION_SIDE - NUM_REACH_GOAL
print(f"测试结果为：到达目标 {NUM_REACH_GOAL} 次， 碰撞边缘 {NUM_COLLISION_SIDE} 次，碰撞障碍 {NUM_COLLISION_OBS} 次，未到达目标 {NUM_FAIL_REACH_GOAL} 次")
